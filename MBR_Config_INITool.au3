...
Global $g_aTitles[50] = ["General", "Debug", "DeleteFiles", "Other", "Android", "Wait4CC", "Wait4CCSpell", "FriendlyChallenge", "Planned", "Attack", "AutoUpgrade", "Boost", "BotHumanization", "BuilderBase", "Capital", "Chatbot", "ClanCastle", "CSVSpeed", "DeleteFiles", "Donate", "DropOrder", "EndBattle", "FMGoblinXP", "FriendlyChallenge", "GTFO", "Lang", "LevelSiege", "LevelTroop", "Notify", "ProfileSCID", "Request", "RequestCC4SiegeMachine", "RequestCC4Troop", "Search"]



Global $g_aTabs[50]
Global $g_alblValue[50]
Global $g_alblVar[50]
Global $g_aCmbKey[50]
Global $g_aTxtValue[50]
Global $g_aBtnReload[50]
Global $g_lblHelp[50]
Global $g_lblHelpInfo[50]
